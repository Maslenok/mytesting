...
document.write('<style type="text/css">input.styled { display: none } select.styled { position: relative; width: ' + selectWidth + 'px; opacity: 0.1; filter: alpha(opacity=10); z-index: 5; } .disabled { opacity: 0.5; filter: alpha(opacity=50); }</style>');
