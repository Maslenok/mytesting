...
def course(request):
    ...
    main_menu = "course"
    context = {'course_list': course_list, "title_name":title_name,"main_menu": main_menu }
...
def tests(request,course_name):
    ...
    main_menu = "course"
    context={'test_list': list_question ,  "title_name":"Содержание курса:  ", "course":course, "main_menu": main_menu }
...
def index(request):
    ...
    context = {'text': text, "title_name":title_name, "main_menu": main_menu }
